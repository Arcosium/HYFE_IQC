...
- 페이지 ID: `brain-api`
- 최종수정: 2026-01-11T05:08:25.939580-05:00
- 분량: PT13M
...
> [HEADING] {"level": "2", "content": "Signing In"}
...
> [HEADING] {"level": "2", "content": "Biometrics Sign In"}
...
> [HEADING] {"level": "2", "content": "Simulating an Alpha"}
...
> [HEADING] {"level": "2", "content": "Waiting for an Alpha Simulation to End and Retrieving Results"}
...
> [HEADING] {"level": "2", "content": "Getting Record Sets of Alpha Simulations"}
...
> [HEADING] {"level": "1", "content": "API Documentation"}

> [HEADING] {"level": "2", "content": "/authentication"}
...
> [HEADING] {"level": "2", "content": "/simulations"}
...
> [HEADING] {"level": "2", "content": "/alphas"}
...
> [HEADING] {"level": "2", "content": "/alphas/<alpha_id>/recordsets"}
...
> [HEADING] {"level": "2", "content": "/alphas/<alpha_id>/recordsets/<record set name>"}
...
> [HEADING] {"level": "1", "content": "Additional Details"}
...
> [HEADING] {"level": "2", "content": "/users/<userid>/activities/diversity"}
...
> [HEADING] {"level": "1", "content": "Troubleshooting common API error messages"}

> [TABLE] {"data": [["Error", "Likely cause & resolution"], ["Invalid data field", "A data field was wrongly used in your Alpha expression. Check if you are using vector data fields with vector operators, or if you have included a matrix data field in a vector operator."], ["Empty output from ace_lib function", "Some of your inputs might be invalid. Check through your inputs to the function.\n\nIf the invalid input is a dataset or data field, check if the dataset or data field is still on the platform through the Data Explorer."], ["Got invalid input at index 0, must be an event data", "An invalid input was detected. Check if you are passing a constant into a vector operator."]], "firstRowIsTableHeader": true, "firstColIsHeader": false}
