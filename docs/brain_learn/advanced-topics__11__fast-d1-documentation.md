...
- 페이지 ID: `fast-d1-documentation`
- 최종수정: 2026-01-15T02:26:37.732416-05:00
- 분량: PT4M

---

> [HEADING] {"level": "1", "content": "What is Fast D1?"}
...
> [IMAGE] {"title": "fast-d1.png", "width": 1222, "height": 379, "fileSize": 32330, "url": "https://api.worldquantbrain.com/content/images/Mc4b-dKXuyNtpGVUgr-NpRDNJC4=/450/original/fast-d1.png"}

> [HEADING] {"level": "1", "content": "How Fast D1 Works"}

**Data Timing Comparison**

Understanding the critical difference in data availability:

> [TABLE] {"data": [["Delay", "Field Type", "Data Timestamp", "Information Captured"], ["1", "snt_buzz", "Yesterday's market close", " Yesterday’s End-of-day data only"], ["Fast D1", "snt_buzz_fast_d1", "Today's market open", "Overnight news, events, pre-market moves"], ["0", "snt_buzz", "30 minutes before today's close", "Close to end of today – harder to execute"]], "firstRowIsTableHeader": true, "firstColIsHeader": false}

**Fast D1 captures the overnight information gap that drives market movements at the open**

> [HEADING] {"level": "1", "content": "Implementation Guide"}

> [HEADING] {"level": "2", "content": "How to Simulate Fast D1 Alphas"}

**Simple 2-Step Process:**

- **Select Delay-1** in simulation settings
- **Use fields with _fast_d1 suffix****Important Notes**
...
> [TABLE] {"data": [["Dataset Id ", "Dataset Category", "Field Count"], ["fundamental3", "fundamental", "393"], ["news21", "news", "83"], ["option24", "option", "82"], ["other696", "other", "66"], ["earningscall_sentiment", "other", "59"], ["model240", "model", "52"], ["model216", "model", "45"], ["model136", "model", "45"], ["other384", "other", "33"], ["news46", "news", "30"], ["earnings7", "earnings", "20"], ["other296", "other", "19"], ["news7", "news", "19"], ["other492", "other", "15"], ["news36", "news", "14"], ["broker24", "broker", "13"], ["search_interest", "other", "12"], ["news104", "news", "11"], ["news13", "news", "8"], ["fundamental110", "fundamental", "7"], ["earnings1", "earnings", "6"], ["socialmedia12", "socialmedia", "6"], ["pv90", "pv", "4"], ["news59", "news", "2"], ["news35", "news", "2"], ["shortinterest30", "shortinterest", "2"], ["other10", "other", "1"], ["", "Total", "1049"]], "firstRowIsTableHeader": true, "firstColIsHeader": false}
...
> [HEADING] {"level": "1", "content": "Best Practices & Technical Considerations"}
...
> [HEADING] {"level": "1", "content": "Submission Guidelines"}
...
> [HEADING] {"level": "1", "content": "Research Directions & Alpha Development"}
...
- **Short interest changes** (shortinterest30)**💡 Priority 2: Delta/Change-Based Alphas**
