...
- 튜토리얼: `create-alphas` (Getting Started)
- 페이지 ID: `simulation-settings`
- 최종수정: 2025-11-05T03:49:33.672757-05:00
- 분량: PT6M
...
> [EQUATION] Decay\_linear(x,n)=\frac{x[date]*n +x[date-1]*(n-1)+...+x[date-n-1]}{n+(n-1)+...+1}
...
> [HEADING] {"level": "1", "content": "Truncation"}
...
> [HEADING] {"level": "1", "content": "Neutralization"}
...
> [IMAGE] {"title": "settings_view", "width": 632, "height": 471, "fileSize": 17439, "url": "https://api.worldquantbrain.com/content/images/1C1nl6f3g3jFuu-vDUjkkVADAdA=/24/original/settings_merged.png"}

> [HEADING] {"level": "1", "content": "Pasteurize"}

> [IMAGE] {"title": "simulation_settings_pasteurize.png", "width": 852, "height": 277, "fileSize": 25761, "url": "https://api.worldquantbrain.com/content/images/AU2Dt8D2W3HWchE9sAKAYJT4l1U=/444/original/simulation_settings_pasteurize.png"}
...
> [SIMULATION_EXAMPLE] {"settings": {"instrumentType": "EQUITY", "region": "USA", "universe": "TOP3000", "delay": 1, "decay": 4, "neutralization": "MARKET", "truncation": 0.01, "pasteurization": "ON", "unitHandling": "VERIFY", "nanHandling": "OFF", "language": "FASTEXPR", "maxTrade": "OFF", "maxPosition": "OFF"}, "type": "REGULAR", "regular": "group_rank(pasteurize(sales_growth),sector) - group_rank(sales_growth,sector)"}
...
> [HEADING] {"level": "1", "content": "Nan Handling"}

> [IMAGE] {"title": "simulation_settings_nan_handling.png", "width": 857, "height": 362, "fileSize": 26635, "url": "https://api.worldquantbrain.com/content/images/tVRsAlPd040erK5r3XAiMgmJNQo=/443/original/simulation_settings_nan_handling.png"}
...
> [SIMULATION_EXAMPLE] {"settings": {"instrumentType": "EQUITY", "region": "USA", "universe": "TOP3000", "delay": 1, "decay": 4, "neutralization": "MARKET", "truncation": 0.01, "pasteurization": "ON", "unitHandling": "VERIFY", "nanHandling": "OFF", "language": "FASTEXPR", "maxTrade": "OFF", "maxPosition": "OFF"}, "type": "REGULAR", "regular": "ts_zscore(etz_eps, 252)"}
...
> [SIMULATION_EXAMPLE] {"settings": {"instrumentType": "EQUITY", "region": "USA", "universe": "TOP3000", "delay": 1, "decay": 3, "neutralization": "NONE", "truncation": 0.01, "pasteurization": "ON", "unitHandling": "VERIFY", "nanHandling": "OFF", "language": "FASTEXPR", "maxTrade": "OFF", "maxPosition": "OFF"}, "type": "REGULAR", "regular": "groupmax(sales, industry)"}
...
> [HEADING] {"level": "1", "content": "Unit Handling"}
