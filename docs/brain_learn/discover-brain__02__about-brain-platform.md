...
- 페이지 ID: `about-brain-platform`
- 최종수정: 2025-09-12T03:33:37.870415-04:00
- 분량: PT6M
...
> [HEADING] {"level": "1", "content": "Alphas"}
...
> [HEADING] {"level": "1", "content": "Alpha Lifecycle"}
...
> [HEADING] {"level": "1", "content": "Weights"}
...
> [HEADING] {"level": "1", "content": "Assigning weights"}
...
> [HEADING] {"level": "1", "content": "Positive and Negative weights"}
...
> [TABLE] {"data": [["Position", "Name", "PnL if stock price rises 1%", "PnL if stock price falls 1%"], ["$100", "Long", "$1", "-$1"], ["-$100", "Short", "-$1", "$1"]], "firstRowIsTableHeader": true, "firstColIsHeader": false}

> [HEADING] {"level": "1", "content": "BRAIN"}
...
![이미지](https://api.worldquantbrain.com/content/images/I_g6YAX-kKGKGKK6ygENw-q6C0I=/53/original/)
