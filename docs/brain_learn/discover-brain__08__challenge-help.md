...
- 페이지 ID: `challenge-help`
- 최종수정: 2025-03-12T05:07:12.194953-04:00
- 분량: PT3M
...
> [HEADING] {"level": "1", "content": "Scoring criteria"}

> [HEADING] {"level": "2", "content": "Summary"}
...
- [Delay](https://support.worldquantbrain.com/hc/en-us/articles/4902349883927-Click-here-for-a-list-of-terms-and-their-definitions#:~:text=days-,Delay,-An) (D1 Alphas contribute more to the score than D0 Alphas)Both factors are then normalized across all the users who submitted at least one Alpha on that particular day. Your final daily score is then function of normalized Quantity and Quality Factors. The daily score is capped at 2,000 points.
