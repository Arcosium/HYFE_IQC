...
- 페이지 ID: `19-alpha-examples`
- 최종수정: 2026-03-11T06:37:41.550288-04:00
- 분량: PT4M

---

> [HEADING] {"level": "1", "content": "Operating Earnings Yield"}
...
> [SIMULATION_EXAMPLE] {"settings": {"instrumentType": "EQUITY", "region": "USA", "universe": "TOP3000", "delay": 1, "decay": 0, "neutralization": "SUBINDUSTRY", "truncation": 0.08, "pasteurization": "ON", "unitHandling": "VERIFY", "nanHandling": "OFF", "language": "FASTEXPR", "maxTrade": "OFF", "maxPosition": "OFF"}, "type": "REGULAR", "regular": "ts_rank(operating_income,252)"}

> [HEADING] {"level": "1", "content": "Appreciation of liabilities"}
...
> [SIMULATION_EXAMPLE] {"settings": {"instrumentType": "EQUITY", "region": "USA", "universe": "TOP3000", "delay": 1, "decay": 0, "neutralization": "SUBINDUSTRY", "truncation": 0.08, "pasteurization": "ON", "unitHandling": "VERIFY", "nanHandling": "OFF", "language": "FASTEXPR", "maxTrade": "OFF", "maxPosition": "OFF"}, "type": "REGULAR", "regular": "-ts_rank(fn_liab_fair_val_l1_a,252)"}

> [HEADING] {"level": "1", "content": "Power of leverage"}
...
> [SIMULATION_EXAMPLE] {"settings": {"instrumentType": "EQUITY", "region": "USA", "universe": "TOP3000", "delay": 1, "decay": 0, "neutralization": "MARKET", "truncation": 0.01, "pasteurization": "ON", "unitHandling": "VERIFY", "nanHandling": "OFF", "language": "FASTEXPR", "maxTrade": "OFF", "maxPosition": "OFF"}, "type": "REGULAR", "regular": "liabilities/assets"}

> [HEADING] {"level": "1", "content": "Earnings Yield Momentum"}
...
> [SIMULATION_EXAMPLE] {"settings": {"instrumentType": "EQUITY", "region": "USA", "universe": "TOP3000", "delay": 1, "decay": 0, "neutralization": "INDUSTRY", "truncation": 0.08, "pasteurization": "ON", "unitHandling": "VERIFY", "nanHandling": "OFF", "language": "FASTEXPR", "maxTrade": "OFF", "maxPosition": "OFF"}, "type": "REGULAR", "regular": "group_rank(ts_rank(est_eps/close, 60),industry)"}

> [HEADING] {"level": "1", "content": "Short-Term Sentiment Volume Stability"}
...
> [SIMULATION_EXAMPLE] {"settings": {"instrumentType": "EQUITY", "region": "USA", "universe": "TOP3000", "delay": 1, "decay": 0, "neutralization": "INDUSTRY", "truncation": 0.08, "pasteurization": "ON", "unitHandling": "VERIFY", "nanHandling": "OFF", "language": "FASTEXPR", "maxTrade": "OFF", "maxPosition": "OFF"}, "type": "REGULAR", "regular": "-ts_std_dev(scl12_buzz, 10)"}
